...
import SeedPropertiesService from '@modules/properties/services/SeedPropertiesServices';
...
(async () => {
  const seedProperties = container.resolve(SeedPropertiesService);
  await seedProperties.execute();
})();
